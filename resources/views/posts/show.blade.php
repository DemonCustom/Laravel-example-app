                ...
                <div class="col-md-offset-1 col-md-10 col-sm-12">
                    <div class="blog-single-post-thumb">
                        <div class="blog-post-format">
                            ...
                            <span><a href="#comments"><i class="fa fa-comment-o"></i> {{ trans_choice(':count комментарий|:count комментария|:count комментариев', $post->comments->count(2)) }}</a></span>
                        </div>
                        ...
                        <div class="blog-comment-form">
                            ...
                            <form action="{{route('comments.store')}}" method="post">
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <input name="submit" type="submit" class="form-control" id="submit" value="Добавить комментарий">
                                </div>
                            </form>
                        </div>
                    </div>
